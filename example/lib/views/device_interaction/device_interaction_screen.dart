                              ...
                              if (snapshot.hasData) {
                                ...
                                return ListView.builder(
                                    ...
                                    itemBuilder: (context, i) {
                                      ...
                                      readMeterData("${filteredItems[i]["name"]}");
                                      return Padding(
                                        padding: EdgeInsets.symmetric(
                                            horizontal: width * .07,
                                            vertical: 10.0),
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              ("${filteredItems[i]["name"]}"
                                                                      .startsWith(
                                                                          "Ele"))
                                                                  ? "${eleMeters["${filteredItems[i]["name"]}"]?[1] ?? 0}"
                                                                  : "${watMeters["${filteredItems[i]["name"]}"]?[1] ?? 0}",
                                                              style: Theme.of(
                                                                      context)
                                                                  .textTheme
                                                                  .bodySmall,
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      ("${filteredItems[i]["name"]}"
                                                              .startsWith(
                                                                  "Ele"))
                                                          ? ("${eleMeters["${filteredItems[i]["name"]}"]?[2] ?? 0}")
                                                          : ("${watMeters["${filteredItems[i]["name"]}"]?[2] ?? 0}"),
                                                      style: Theme.of(context)
                                                          .textTheme
                                                          .bodySmall,
                                                    ),
